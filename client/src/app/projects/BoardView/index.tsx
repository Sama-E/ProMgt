...
import { useGetTasksQuery, useUpdateTaskPriorityMutation, useUpdateTaskStatusMutation } from '@/state/api';
...
const BoardView = ({ id, setIsModalNewTaskOpen }: BoardProps) => {
    ...
    //DndProvider - drag and drop provider
    //HTML5Backend - customization for DndProvider
